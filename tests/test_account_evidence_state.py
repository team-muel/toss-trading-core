...
from asset_management.compatibility.reference.universe import InstrumentMapping
...
class AccountEvidenceAccountStateTest(unittest.TestCase):
    ...
    def test_snapshotter_stores_and_explains_toss_account_state(self):
        ...
        result = AccountEvidenceSnapshotter(fake, ledger).snapshot(
            account_seq="1",
    ...
    def test_execution_delta_is_not_duplicated_for_same_cumulative_snapshot(self):
        ...
        first = AccountEvidenceSnapshotter(fake, ledger).snapshot(account_seq="1")
        second = AccountEvidenceSnapshotter(fake, ledger).snapshot(account_seq="1")
    ...
    def test_latest_empty_snapshots_do_not_reuse_stale_holdings_or_open_orders(self):
        ...
        AccountEvidenceSnapshotter(populated, ledger).snapshot(account_seq="1")
        ...
        empty.ledger = ledger
        AccountEvidenceSnapshotter(empty, ledger).snapshot(account_seq="1")
