...
from asset_management.compatibility.account_evidence import AccountLedger, replay_account_evidence_run
from asset_management.compatibility.account_evidence.replay import _accounts_for_bound_run


class AccountEvidenceReplayTest(unittest.TestCase):
    ...
    def test_replay_rebuilds_normalized_rows_from_raw_responses(self):
        with TemporaryDirectory() as tmp:
            ...
            result = replay_account_evidence_run(
