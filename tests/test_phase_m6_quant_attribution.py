...
def inputs(benchmark="SPY@1", residual=Decimal(".02")):
...
def test_unreconciled_pnl_components_fail_closed():
    with pytest.raises(InvariantViolation,match="PNL_RECONCILIATION_FAILED"):
        inputs(residual=Decimal(0))
