...
| --- | --- | --- |
| #63 | `8588371` | Transplanted: contextual stress and event-risk controls. |
| #64 | `2e1aa06` | Not transplanted: the OpenAPI 1.2.15 approval is already present through AMA-133. |
| #65 | `0a5b707` | Transplanted: Gate D2 pricing/expectation/risk acceptance. |
| #66 | `0c9f9ec` | Transplanted and reconciled with existing availability-time and manifest lineage. |
| #67 | `ed3a46f` | Transplanted: authorized model-relative-alpha assessment. |
| #68 | `3a4c1f7` | Transplanted: PIT factor and specific-risk assessment. |
| #69 | `69a114a` | Transplanted: model-scope calculation lineage binding. |
| #70 | `a1243cf` | Transplanted: planned capital-flow reserve assessment. |
| #71 | `696ff40` | Transplanted: duplicate confidence risk-scaling rejection. |
| #72 | `1e2f1f0` | Transplanted: optimizer return-semantic restriction. |
| #73 | `c82bb51` | Transplanted: typed economic trade evidence. |
