...
from asset_management.compatibility.account_evidence.ledger import AccountLedger, AccountStateExplanation
from asset_management.toss.contracts import require_accounts
...
class AccountEvidenceSnapshotResult:
    run_id: str
    accounts: int
    holdings: int
    open_orders: int
...
class AccountEvidenceSnapshotter:
    ...
    def snapshot(
        ...
        *,
        ...
        try:
            ...
            return AccountEvidenceSnapshotResult(
                run_id=run_id,
                accounts=accounts,
                holdings=holdings,
