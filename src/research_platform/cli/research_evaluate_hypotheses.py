...
from research_platform.cli.research_backtest import _total_return_manifest_ids
from research_platform import (
    MacroVintageObservation,
    PricePoint,
    load_alfred_from_manifests,
)
from research_platform.costs import ExecutionCostModel, load_execution_cost_model
from research_platform.candidate_evaluation import (
    evaluate_hypothesis,
    evaluate_prospective_hypothesis,
)
from research_platform.hypotheses import HypothesisLedger, load_research_policy
from asset_management.compatibility.reference.universe import load_instrument_mappings
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--code-revision",
        default=os.environ.get("RESEARCH_CODE_REVISION", "unknown"),
    )
